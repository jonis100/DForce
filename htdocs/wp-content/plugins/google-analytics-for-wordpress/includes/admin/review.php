	...
	public function review() {
		...
		<div class="notice notice-info is-dismissible monsterinsights-review-notice">
			<div class="monsterinsights-review-step monsterinsights-review-step-1">
				...
				<p>
					<a href="#" class="monsterinsights-review-switch-step"
			...
			<div class="monsterinsights-review-step monsterinsights-review-step-2" style="display: none">
				...
				<p>
					<a href="<?php echo esc_url( $feedback_url ); ?>"
					   class="monsterinsights-dismiss-review-notice monsterinsights-review-out"><?php esc_html_e( 'Give Feedback', 'google-analytics-for-wordpress' ); ?></a><br>
					<a href="#" class="monsterinsights-dismiss-review-notice" target="_blank"
			...
			<div class="monsterinsights-review-step monsterinsights-review-step-3" style="display: none">
				...
				<p>
					<a href="https://wordpress.org/support/plugin/google-analytics-for-wordpress/reviews/?filter=5#new-post"
					   class="monsterinsights-dismiss-review-notice monsterinsights-review-out" target="_blank"
